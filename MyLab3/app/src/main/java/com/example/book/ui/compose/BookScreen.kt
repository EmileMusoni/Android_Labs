        ...
        { val checkedState = remember { mutableStateOf(false) }
            Row {
                Checkbox(
                    ...
                    onCheckedChange = { showDeleteDialog = true; checkedState.value = it },

                )
                Text(text = item.bookName, style = MaterialTheme.typography.h6,modifier = Modifier.padding(22.dp))
               // Text(text = item.author, style = MaterialTheme.typography.h6,modifier = Modifier.padding(22.dp))
            }
